...
public class RightDoubleDragMouse 
{
	WebDriver driver;
  ...
  public void mousehover() throws Exception 
  {
	  ...
	  Actions act =new Actions (driver);
	  act.moveToElement(driver.findElement(By.id("//*[@id=\"menu-336-1\"]"))).build().perform();
	  Thread.sleep(3000);
  ...
  {
	  driver.get("http://www.seleniumlearn.com/drage-and-drop-html");
	  Thread.sleep(5000);
